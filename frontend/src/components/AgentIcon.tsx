...
/**
 * Animated gradient "AI" badge used to represent the Agente de Salud everywhere in the UI
 * (sidebar nav, chat header) - a soft pulsing glow behind a Sparkles glyph, standing out
 * from the plain static lucide icons used by the other nav items.
 */
